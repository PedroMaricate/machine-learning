...
=== "gender"
    ...
    ![Frequência de gênero por aplicações](img/frequencia_genero_aplicacoes.png)
...
=== "international"
    ...
    ![Frequência de alunos internacionais por aplicações](img/frequencia_alunos_internacionais.png)
...
=== "gpa"
    ...
    ![Distribuição do GPA dos candidatos](img/distribuicao_gpa_boxplot.png)
...
=== "major"
    ...
    ![Frequência de áreas de formação (majors)](img/frequencia_majors.png)
...
=== "race"
    ...
    ![Frequência de raça por aplicações](img/frequencia_raca.png)
...
=== "gmat"
    ...
    ![Distribuição das pontuações de GMAT](img/distribuicao_gmat.png)
...
=== "work_exp"
    ...
    ![Distribuição da experiência profissional](img/distribuicao_experiencia_profissional.png)
...
=== "work_industry"
    ...
    ![Frequência por setor de experiência profissional](img/frequencia_setor_experiencia_profissional.png)
